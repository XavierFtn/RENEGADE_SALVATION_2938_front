...
function ListShips() {
    ...
    <p>You don't have any ships at the moment.</p> : 
    null;
}
...
function ListWarehouses() {
    ...
    <p>You need to build warehouses to stock your ressources.</p> : 
    null;
}
...
function ListInfrastructures() {
    ...
    const messageInfrastructures = () => { 
        return infrastructures.length === 0 ? 
    <p>Build infrastructures to launch your ressource production.</p> : 
    null;
}
...
function ListPending() {
    ...
    <p>You have no constructions pending.</p> : 
    null;
}
